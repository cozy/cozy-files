...
module.exports = class FileView extends BaseView
    ...
    mimeClasses:
        ...
        'application/postscript'        : 'fa-image-o'
        'image/gif'                     : 'fa-image-o'
        'image/jpeg'                    : 'fa-image-o'
        'image/pjpeg'                   : 'fa-image-o'
        'image/x-pict'                  : 'fa-image-o'
        'image/pict'                    : 'fa-image-o'
        'image/png '                    : 'fa-image-o'
        'image/x-pcx'                   : 'fa-image-o'
        'image/x-portable-pixmap'       : 'fa-image-o'
        'image/x-tiff'                  : 'fa-image-o'
        'image/tiff'                    : 'fa-image-o'
