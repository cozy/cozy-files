...
var CozyAdapter, CozyInstance, File, Folder, NotificationHelper, async, clearance, cozydomain, doSendNotif, e, fs, jade, mailsToSend, notifications, notiftemplate, publicURL, templatefile, timer, _5min;
...
publicURL = function(doc) {
  if (doc instanceof File) {
    ...
    return "" + cozydomain + "public/files/folder/" + doc.id;
  } else {
