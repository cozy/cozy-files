...
module.exports = FileView = (function(_super) {
  ...
  FileView.prototype.initialize = function(options) {
    ...
    this.listenTo(this.model, 'request', (function(_this) {
      return function() {
        return _this.$('.spinholder').spin('small');
      };
    })(this));
  ...
  FileView.prototype.displayError = function(msg) {
    if (this.errorField == null) {
      this.errorField = $('<span class="error">').insertAfter(this.$('.tags'));
    }
    if (msg === false) {
...
{
buf.push("<div class=\"caption btn btn-link\"><span class=\"icon-zone\"><input type=\"checkbox\" class=\"selector\"/>");
...
if ( !isBeingUploaded)
{
buf.push("<div class=\"operations\"><a class=\"file-tags\"><span class=\"fa fa-tag\"></span></a><a" + (jade.attr("title", "" + (t('tooltip share')) + "", true, false)) + " class=\"file-share\">");
if ( clearance == 'public')
{
...
buf.push("</div>&nbsp;<a id=\"button-new-folder\"" + (jade.attr("title", t('new folder button'), true, false)) + " class=\"btn btn-cozy\"><img src=\"images/add-folder.png\"/></a><div id=\"bulk-actions-btngroup\" class=\"btn-group\"><a id=\"button-bulk-download\"" + (jade.attr("title", "" + (t('download all')) + "", true, false)) + " class=\"btn btn-cozy btn-cozy\"><span class=\"icon-arrow-down icon-white\"></span></a><a id=\"button-bulk-move\"" + (jade.attr("title", "" + (t('move all')) + "", true, false)) + " class=\"btn btn-cozy btn-cozy\"><span class=\"glyphicon glyphicon-arrow-right\"></span></a><a id=\"button-bulk-remove\"" + (jade.attr("title", "" + (t('remove all')) + "", true, false)) + " class=\"btn btn-cozy btn-cozy\"><span class=\"glyphicon glyphicon-remove-circle\"></span></a></div></div>");
if ( isPublic && hasPublicKey)
{
