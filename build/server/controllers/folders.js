...
var CozyInstance, File, Folder, KB, MB, archiver, async, findFolder, getFolderPath, jade, log, moment, pathHelpers, publicfoldertemplate, sharing;
...
module.exports.modify = function(req, res) {
  var folder, hasntTheSamePathOrIsTheSame, isPublic, newName, newPath, newTags, oldPath, updateFoldersAndFiles, updateIfIsSubFolder, updateTheFolder;
  folder = req.folder;
...
module.exports.destroy = function(req, res) {
  var destroyIfIsSubdirectory, directory, folder;
  folder = req.folder;
...
module.exports.zip = function(req, res) {
  var addToArchive, folder, makeZip;
  folder = req.folder;
  ...
  return getFolderPath(req.params.folderid, function(err, key) {
    if (err) {
      return next(err);
    } else {
      return File.all(function(err, files) {
        var file, selectedFiles, zipName, _i, _len, _ref;
        if (err) {
          return next(err);
        } else {
