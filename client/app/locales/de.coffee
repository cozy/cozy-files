...
Mozilla Firefox unterstütz kein Hochladen von Ordner. Wenn Sie dieses
...
"""
    ...
    "upload msg selected"       : """
        Sie haben die Datei %{smart_count} ausgewählt, klicken Sie Hinzufügen um diese hochzuladen. ||||
