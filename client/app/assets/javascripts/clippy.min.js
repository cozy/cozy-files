...
clippy.Animator.prototype = {
    _setupElement:function (el) {
        ...
        el.css('background', "url('./images/clippy-map.png') no-repeat");
...
clippy.load._loadSounds = function (name, path) {
    ...
    if (!canPlayMp3 && !canPlayOgg) {
        ...
        var src = 'javascripts/' + (canPlayMp3 ? 'clippy-sounds-mp3.js' : 'clippy-sounds-ogg.js');
        // load
...
clippy.load._loadAgent = function (name, path) {
    ...
    var src = 'javascripts/clippy-agent.js';
