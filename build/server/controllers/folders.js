...
var CozyInstance, File, Folder, KB, MB, archiver, async, findFolder, getFolderPath, jade, log, moment, normalizePath, pathHelpers, publicfoldertemplate, sharing, template;
      ...
      if (err != null) {
        ...
        if (key != null) {
          isAuthorized = function(element, callback) {
            return sharing.checkClearance(element, req, callback);
          };
