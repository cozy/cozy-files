...
var File, async, fs, processAttachement, sharing;
      ...
      return function(err, files) {
        ...
        return async.every(files, hasntTheSamePath, function(available) {
          ...
          if (!available) {
            ...
            return File.create(data, (function(_this) {
...
module.exports.modify = function(req, res) {
  var fileToModify, hasntTheSamePathOrIsTheSame, isPublic, newName, newPath;
  if (!req.body.name || req.body.name === "") {
    return res.send({
      error: true,
...
module.exports.search = function(req, res) {
  return File.search("*" + req.body.id + "*", function(err, files) {
    if (err) {
      return res.send({
        error: true,
        msg: err
