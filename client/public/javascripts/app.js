...
window.require.register("helpers/init", function(exports, require, module) {
  var File, Folder;
    ...
    return Folder.all(function(err, folders) {
      ...
      if (err) {
        ...
        for (_i = 0, _len = folders.length; _i < _len; _i++) {
          folder = folders[_i];
          _results.push(folder.index(['name']));
        }
        return _results;
      }
    });
...
window.require.register("lib/folder_helpers", function(exports, require, module) {
  module.exports = {
...
window.require.register("locales/ro", function(exports, require, module) {
  module.exports = {
    "modal error": "Eroare",
    "modal ok": "OK",
...
window.require.register("views/file", function(exports, require, module) {
  var BaseView, FileView, ModalShareView, ModalView, TagsView, client, _ref,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
window.require.register("views/folder", function(exports, require, module) {
  var BaseView, BreadcrumbsView, File, FileCollection, FilesView, FolderView, Helpers, ModalShareView, ModalView, ProgressbarView, _ref,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  module.exports = FolderView = (function(_super) {
    ...
    FolderView.prototype.changeActiveFolder = function(folder) {
      var clearance, shareState, zipLink, _ref1,
        _this = this;
...
window.require.register("views/modal_share", function(exports, require, module) {
  var BaseView, CozyClearanceModal, Modal, ModalShareView, client, _ref,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  ...
  module.exports = ModalShareView = (function(_super) {
    ...
    ModalShareView.prototype.events = function() {
      ...
      return _.extend(ModalShareView.__super__.events.apply(this, arguments), {
        'click #inherited-share-summary a': function() {
    ...
    ModalShareView.prototype.afterRender = function() {
      var checkbox, folder, guestCanWrite, html, item, label, list, listitems, rule, summary, text, _i, _j, _k, _len, _len1, _len2, _ref1, _ref2;
...
window.require.register("views/public_folder", function(exports, require, module) {
  var File, FileCollection, FilesView, FolderView, PublicFilesView, PublicFolderView, _ref, _ref1,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  PublicFilesView = (function(_super) {
    ...
    function PublicFilesView() {
      _ref = PublicFilesView.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  module.exports = PublicFolderView = (function(_super) {
    ...
    function PublicFolderView() {
      _ref1 = PublicFolderView.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
