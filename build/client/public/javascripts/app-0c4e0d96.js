...
;require.register("views/file_legacy", function(exports, require, module) {
var BaseView, FileView, ModalShareView, ModalView, ProgressBar, TagsView, client, mimeClasses,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = FileView = (function(_super) {
  ...
  FileView.prototype.getRenderData = function() {
    return _.extend(FileView.__super__.getRenderData.call(this), {
      mimeClass: mimeClasses[this.model.mime],
      isBeingUploaded: this.model.isBeingUploaded(),
      attachmentUrl: this.model.getAttachmentUrl(),
      downloadUrl: this.model.getDownloadUrl(),
      clearance: this.model.getClearance()
  ...
  FileView.prototype.onRequest = function() {
    this.$('.spinholder').show();
    return this.$('.icon-zone .fa').addClass('hidden');
  };
  ...
  FileView.prototype.onSyncError = function() {
    ...
    this.$('.spinholder').hide();
    return this.$('.icon-zone .fa').removeClass('hidden');
  };
